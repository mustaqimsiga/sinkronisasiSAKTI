...
FROM (
    ...
    FROM   FND_USER@SPAN_ST                    FU
          ,HR.PER_ALL_ASSIGNMENTS_F@SPAN_ST    PAA
          ,HR.PER_ALL_POSITIONS@SPAN_ST        PAP
          ,HR.PER_ALL_PEOPLE_F@SPAN_ST         PAF
          ,FND_RESPONSIBILITY_VL@SPAN_ST       R
          ,FND_USER_RESP_GROUPS_DIRECT@SPAN_ST RG
